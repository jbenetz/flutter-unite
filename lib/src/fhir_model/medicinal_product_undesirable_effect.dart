...
class MedicinalProductUndesirableEffect {
    ...
    MedicinalProductUndesirableEffect.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.symptomConditionEffect = json['symptomConditionEffect'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['symptomConditionEffect']);
        this.classification = json['classification'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['classification']);
        this.frequencyOfOccurrence = json['frequencyOfOccurrence'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['frequencyOfOccurrence']);
