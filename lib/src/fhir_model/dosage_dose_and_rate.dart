...
class DosageDoseAndRate {
    ...
    DosageDoseAndRate.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.doseRange = json['doseRange'] == null ? null : FHIRObjectFactory.buildFromJSON('Range', json['doseRange']);
        ...
        this.rateRange = json['rateRange'] == null ? null : FHIRObjectFactory.buildFromJSON('Range', json['rateRange']);
