...
import 'value_set_compose.dart';
import 'value_set_expansion.dart';
...
class ValueSet {
    ...
    ValueSet.fromJSON( Map json ){
        ...
        this.extImmutable = json['_immutable'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_immutable']);
        ...
        this.compose = json['compose'] == null ? null : FHIRObjectFactory.buildFromJSON('ValueSetCompose', json['compose']);
        this.expansion = json['expansion'] == null ? null : FHIRObjectFactory.buildFromJSON('ValueSetExpansion', json['expansion']);
    }
}
