...
class FHIRList {
    ...
    FHIRList.fromJSON( Map json ){
        ...
        this.orderedBy = json['orderedBy'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['orderedBy']);
        ...
        this.entry = List<ListEntry>();
        if (json['entry'] != null && json['entry'].length > 0) {
          if( json['entry'] is List ){
            json['entry'].forEach((i){
              this.entry.add(FHIRObjectFactory.buildFromJSON('ListEntry', i));
            });
          } else {
            // this handles the case when the list only has one object and does not return as a list
            var i = json['entry'];
        ...
        this.emptyReason = json['emptyReason'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['emptyReason']);
    }
}
