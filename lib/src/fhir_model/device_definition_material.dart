...
class DeviceDefinitionMaterial {
    ...
    DeviceDefinitionMaterial.fromJSON( Map json ){
        ...
        this.alternate = json['alternate'];
        this.extAlternate = json['_alternate'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_alternate']);
