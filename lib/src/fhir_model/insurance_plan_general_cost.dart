...
class InsurancePlanGeneralCost {
    ...
    InsurancePlanGeneralCost.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.extGroupSize = json['_groupSize'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_groupSize']);
        this.cost = json['cost'] == null ? null : FHIRObjectFactory.buildFromJSON('Money', json['cost']);
