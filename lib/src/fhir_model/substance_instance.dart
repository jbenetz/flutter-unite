...
class SubstanceInstance {
    ...
    SubstanceInstance.fromJSON( Map json ){
        this.id = json['id'];
        ...
        if( json['expiry'] != null ) { this.expiry = DateTime.parse(json['expiry']);}
        this.extExpiry = json['_expiry'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_expiry']);
