...
class BodyStructure {
    ...
    BodyStructure.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.morphology = json['morphology'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['morphology']);
        this.location = json['location'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['location']);
        this.locationQualifier = List<CodeableConcept>();
        if (json['locationQualifier'] != null && json['locationQualifier'].length > 0) {
          if( json['locationQualifier'] is List ){
            json['locationQualifier'].forEach((i){
              this.locationQualifier.add(FHIRObjectFactory.buildFromJSON('CodeableConcept', i));
            });
          } else {
            // this handles the case when the list only has one object and does not return as a list
            var i = json['locationQualifier'];
            this.locationQualifier.add(FHIRObjectFactory.buildFromJSON('CodeableConcept', i));
          }          
        }
