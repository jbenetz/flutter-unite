...
class SubstanceSpecificationOfficial {
    ...
    SubstanceSpecificationOfficial.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.authority = json['authority'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['authority']);
