...
class QuestionnaireAnswerOption {
    ...
    Element extInitialSelected;
 
    QuestionnaireAnswerOption.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.initialSelected = json['initialSelected'];
        this.extInitialSelected = json['_initialSelected'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_initialSelected']);
    }
}
