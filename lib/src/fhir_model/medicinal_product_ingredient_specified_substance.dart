...
class MedicinalProductIngredientSpecifiedSubstance {
    ...
    MedicinalProductIngredientSpecifiedSubstance.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.group = json['group'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['group']);
        this.confidentiality = json['confidentiality'] == null ? null : FHIRObjectFactory.buildFromJSON('CodeableConcept', json['confidentiality']);
