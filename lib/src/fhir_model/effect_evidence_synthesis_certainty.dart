...
import 'effect_evidence_synthesis_certainty_subcomponent.dart';
...
class EffectEvidenceSynthesisCertainty {
    ...
    EffectEvidenceSynthesisCertainty.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.certaintySubcomponent = List<EffectEvidenceSynthesisCertaintySubcomponent>();
        if (json['certaintySubcomponent'] != null && json['certaintySubcomponent'].length > 0) {
          if( json['certaintySubcomponent'] is List ){
            json['certaintySubcomponent'].forEach((i){
              this.certaintySubcomponent.add(FHIRObjectFactory.buildFromJSON('EffectEvidenceSynthesisCertaintySubcomponent', i));
            });
          } else {
            // this handles the case when the list only has one object and does not return as a list
