...
class MedicinalProductIngredientReferenceStrength {
    ...
    MedicinalProductIngredientReferenceStrength.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.strengthLowLimit = json['strengthLowLimit'] == null ? null : FHIRObjectFactory.buildFromJSON('Ratio', json['strengthLowLimit']);
