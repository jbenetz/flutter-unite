...
class DeviceDefinitionSpecialization {
    ...
    Element extSystemType;
    /// The version of the standard that is used to operate and communicate.
    String version;
    /// Extensions for version
    Element extVersion;
 
    DeviceDefinitionSpecialization.fromJSON( Map json ){
        this.id = json['id'];
        ...
        this.extSystemType = json['_systemType'] == null ? null : FHIRObjectFactory.buildFromJSON('Element', json['_systemType']);
